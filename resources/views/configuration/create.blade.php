...
@section('content')
<h1 class="app-page-title">Ajouter une nouvelle config</h1>
<hr class="mb-4">
...
<circle cx="8" cy="4.5" r="1"/>
                ...
                <div class="auto col">
                        <select class="form-select "name="type" id="type" class="form-control" value="{{ old('type') }}">
                            <option value=""></option>
                            <option value="PAYEMENT_DATE">Date de paiement</option>
                            <option value="APP_NAME">Nom de l'App</option>
...
<circle cx="8" cy="4.5" r="1"/>
                        ...
                        <input type="text" class="form-control" id="setting-input-1" placeholder="Entrez la valeur" name="value" value="{{ old('value') }}" required >
