...
@section('content')
<h1 class="app-page-title">Ajouter un Departement</h1>
<hr class="mb-4">
...
<circle cx="8" cy="4.5" r="1"/>
                        ...
                        <input type="text" class="form-control" id="setting-input-1" placeholder="Entrez le nom" name="name" value="{{ old('name', $departement->name) }}" required >
