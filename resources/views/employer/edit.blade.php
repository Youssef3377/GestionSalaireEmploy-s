...
@section('content')
<h1 class="app-page-title">Modifier un Employé</h1>
<hr class="mb-4">
<div class="row g-4 settings-section">
    <div class="col-12 col-md-4">
        <h3 class="section-title">Edition</h3>
        <div class="section-intro">Lors de la mise à jour des informations de l'employé, merci de vérifier attentivement les identifiants saisis (nom, prénom, adresse e-mail, numéro de contact, etc.). Une erreur pourrait entraîner des problèmes dans le traitement des données ou l’accès aux systèmes.
