...
<div class="row g-4 settings-section">
    <div class="col-12 col-md-4">
        ...
        <div class="section-intro">Lors de l’enregistrement d\’un administrteur, merci de vérifier attentivement les identifiants saisis (nom, prénom, adresse e-mail, numéro d’employé, etc.). Une erreur pourrait entraîner des problèmes dans le traitement des données ou l’accès aux systèmes.
    ...
    <div class="col-12 col-md-8">
        <div class="app-card app-card-settings shadow-sm p-4">
            ...
            <div class="app-card-body">
                <form class="settings-form"  action="{{route('administrateur.store')}}  " method="POST">
                    @csrf
                    @method('POST')
...
<circle cx="8" cy="4.5" r="1"/>
                        ...
                        <input type="text" class="form-control" id="setting-input-1"value="{{old('name')}}" placeholder="Entrez votre nom et prenom" name="name" required>
                        @error('name')
